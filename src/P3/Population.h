...
class Population {
 public:
  ...
  void improve(Random& rand, vector<bool> & solution, float & fitness,
               Evaluator& evaluator, bool  b_multi_obj_domination_fitness_compare = false);
...
private:
  ...
  bool donate(vector<bool> & solution, float & fitness, vector<bool> & source,
      const vector<int> & cluster, Evaluator& evaluator, bool  b_multi_obj_domination_fitness_compare = false);
