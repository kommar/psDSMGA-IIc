...
using pointer=void (*)(Random & rand, vector<bool> & solution, float & fitness, Evaluator& evaluator, bool  bMultiObjDominationFitnessCompare);
...
void first_improvement(Random & rand, vector<bool> & solution, float & fitness,
                       Evaluator& evaluator, bool  bMultiObjDominationFitnessCompare);
