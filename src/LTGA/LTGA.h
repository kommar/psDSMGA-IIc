...
namespace NLTGA
{
	...
	private:
		...
		bool exceedsMaxDistanceExcludingMask(int first_solution, int second_solution, int lt_index, int *max_distance);
		bool exceedsMaxDistanceOnlyMask(int first_solution, int second_solution, int lt_index, int *max_distance);
		int betterMaxDistanceExcludingMask(int which, int first_donor, int second_donor, int lt_index);
		int betterMaxDistanceOnlyMask(int which, int first_donor, int second_donor, int lt_index);
		int getDonor(int which, int lt_index);
